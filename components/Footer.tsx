...
const Footer = () => {
  return (
    <>
      <footer className="w-full rounded-lg bg-white shadow border dark:bg-gray-800 md:flex md:items-center md:justify-between overflow-hidden mt-8">
        <div className="flex w-full flex-col gap-y-6 lg:flex-row lg:justify-between lg:gap-y-0 pt-3 px-3 overflow-hidden">
          ...
          >
            ...
            <li className="last:mr-0 md:mr-6 mr-3">
              <a href="#" className="hover:underline">
                Sponsors
              </a>
            </li>
          ...
          <ul className="flex flex-wrap text-sm text-gray-500 dark:text-white pb-2">
            <div className="flex gap-4 md:gap-0">
              <li className="last:mr-0 md:mr-6 hover:[&amp;>*]:text-black dark:hover:[&amp;>*]:text-gray-300">
                <a href="#" className="hover:underline">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
